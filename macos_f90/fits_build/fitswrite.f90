...
#if 0
Program test_fitswrite
  Implicit none
  Integer, parameter :: img_sz=511
  Real*8 :: img_in(img_sz,img_sz)
  Integer :: j
  Character(len=80) :: fits_filename

  fits_filename='newimg.fits';

  Open(unit=12,file='Opd.txt',status='old')
  Do j=1,img_sz
    Read(12,*) img_in(1:img_sz,j)
  End Do;
  Close(12)

  Call fitswrite(fits_filename,img_in,img_sz)
End Program;
#endif
