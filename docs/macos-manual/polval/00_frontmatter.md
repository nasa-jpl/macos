...
| | |
|---|---|
| Generated | 2026-07-27 09:45:41 |
| Engine (`macos`) | `25c4386` on `pol-core` |
| Bindings (`MACOS_resources`) | `fc2e22e` on `pol-core` |
| MATLAB | R2026a |
| Model size | 128 |
| Host | red-river |
| Figure / number consistency | consistent (8 figures, all older than numbers.json) |
