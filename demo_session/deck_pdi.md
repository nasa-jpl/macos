...
## The P/SRI as a buildable bench: two balanced arms | A 45° plate behind the DM return splits the beam; the reference arm focuses onto the pinhole seat and recollimates, the test arm folds around it; a second plate recombines both into one camera
::: full
![Looking down on the bench: test deck orange, reference arm blue, leg lengths in millimeters; BS2 (13) splits, M1 (15), the compensator (16–17) and BS3 (18) carry the test arm, Lr1 (14), the pinhole (17), Lr2 (20) and M3 (22) the reference arm; then L2 (19), the relay and the camera (24).](figs/psri_layout.png){h=5.2}
~ macos.design.psri_bench: equal plate glass per arm; a 21.9 mm plate in the test arm nulls the lens glass (chief optical paths 4453.1 mm each); M3 placed so the exit chiefs coincide (2×10⁻¹³ mm); Lr1 conic −0.578 (0.1 µm blur), pinhole at the true focus (+1.10 mm), Lr2 = Lr1 mirrored; the photonic chip and its phase shifter occupy the pinhole seat; both plates 60/40.
