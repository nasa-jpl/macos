...
function []=writeKcEltValues(writeKcElt_fname,ElementData,wElt)
%==========================================================================
...
%--------------------------------------------------------------------------
if exist(writeKcElt_fname) == 2;	%fname already exists as file
    if overwrite_wfname;
        warning([writeKcElt_fname ' already exists, and it is being deleted'])
        disp(['Deleting ' writeKcElt_fname])
        delete(writeKcElt_fname);
    else
        warning([writeKcElt_fname ' already exists!!!'])
        return
    end
end

fname_id = fopen(writeKcElt_fname,'w');
%==========================================================================
