...
eval $(ifx -C -traceback -fstack-protector -O -shared-intel -shared  -Wl,--no-undefined -o  "smacos_dvr"  smacos_dvr.o     -l:libmx.so -l:libmex.so -lmat -L/opt/intel-14.0.0/oneapi/compiler/2023.1.0/linux/compiler/lib/intel64 -lirc -lm -lstdc++  $macossrc_dir/SMACOS_OBJS/Linux-x86_64/smacos_lib.a)
